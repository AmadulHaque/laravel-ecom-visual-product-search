    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="mb-6">
        <form action="{{ route('products.search') }}" method="post" enctype="multipart/form-data">
            @csrf
            <input type="file" name="image" accept="image/*" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            @error('image')
